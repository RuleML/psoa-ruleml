PSOATransRun 1.3.1 README                                              2018-03-30
...
USAGE
Download http://psoa.ruleml.org/transrun/1.3.1/local/PSOATransRunLocal.jar to 
...
PSOATransRun 1.3.1 RELEASE NOTES
* Added command line options
* Omitted () from op() to obtain TPTP's and ISO Prolog's op
